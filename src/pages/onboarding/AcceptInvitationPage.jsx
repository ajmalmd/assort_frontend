...
const AcceptInvitationPage = () => {
  ...
  if (status === "loading") {
    return (
      <div className="min-h-screen flex bg-background py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="min-h-screen flex bg-background py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto w-full">
          <div className="bg-white rounded-lg border border-border shadow-sm">
            ...
            <div className="flex justify-end items-center px-8 py-6 border-t border-border bg-gray-50 rounded-b-lg">
              <button
                onClick={handleGoHome}
                className="px-6 py-2 bg-primary text-white hover:bg-primary/90 rounded-lg font-medium"
              >
                Go Home
              </button>
            </div>
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                disabled
                className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 text-muted-foreground focus:outline-none"
              />
            </div>
          </div>

          <div className="flex justify-end items-center px-8 py-6 border-t border-border bg-gray-50 rounded-b-lg gap-3">
            <button
              onClick={handleGoHome}
            ...
            <button
              ...
              className="px-6 py-2 bg-primary text-white hover:bg-primary/90 disabled:opacity-50 rounded-lg font-medium"
            >
